...
tools = [
    Tool(name="groq",   func=groq_tool,   description="Generate recipes via Groq."),
    Tool(name="gemini", func=gemini_tool, description="Generate recipes via Google Gemini."),
]
...
def run_agent(recipe_name: str, language_option: str, model: str = None) -> str:
    # Build the task prompt

    prompt = build_prompt(language_option, recipe_name, model)
    # print("prompt got")
